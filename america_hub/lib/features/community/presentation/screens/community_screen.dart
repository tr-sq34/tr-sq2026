                ...
                Padding(
                  ...
                  child: _PostCard(
                    ...
                    onDelete: post.ownerId == 'local-user'
                        ? () => _deletePost(post)
                        : null,
                    onOpenComments: () => showAppBottomSheet(
                      context: context,
...
class _CommentsSheetState extends State<_CommentsSheet> {
  ...
  void initState() {
    super.initState();
    widget.controller.load(widget.post.id);
  }
  ...
  Widget build(BuildContext context) => SizedBox(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          widget.post.commentsPolicy == CommentsPolicy.disabled
              ? 'Bu paylaşım yorumlara kapalı.'
              : 'Arkadaşlarınla sohbete katıl.',
            ...
            builder: (context, _) {
              ...
              if (state is AsyncFailure<List<CommunityComment>>)
                return AppErrorState(
                  ...
                  onRetry: () => widget.controller.load(widget.post.id),
                );
              ...
              return ListView.separated(
                ...
                itemBuilder: (_, index) {
                  ...
                  return _CommentThread(
                    ...
                    onDelete: (item) => widget.controller.deleteComment(
                      comment: item,
                      post: widget.post,
                      viewerId: 'local-user',
                    ),
                    canDelete: (item) => PostAccessPolicy.canDeleteComment(
                      comment: item,
                      post: widget.post,
                      viewerId: 'local-user',
                    ),
        ...
        if (widget.post.commentsPolicy != CommentsPolicy.disabled) ...[
          const Divider(height: 22),
          if (_replyingTo != null)
            Padding(
