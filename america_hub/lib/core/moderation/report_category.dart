/// Why something is being reported — a message, a post, a comment or a story.
///
/// The wire value is what the services store and what the moderation queue
...
///
/// It lives in core rather than under messaging because both the messaging
/// gateway and the community service accept exactly these values. Two copies
/// would drift, and the first symptom of the drift would be a report the
/// backend rejects at the moment someone needed it most.
enum ReportCategory {
  childSafety(
    'child_safety',
    'Çocuk güvenliği',
