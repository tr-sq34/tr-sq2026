    ...
    Statement = [{
      ...
      Condition = { StringEquals = {
        ...
        "token.actions.githubusercontent.com:sub" = [
          "repo:tr-sq34@309652758/tr-sq2026@1313519494:environment:verification-vault-production",
          "repo:tr-sq34/tr-sq2026:environment:verification-vault-production",
        ]
      } }
    }]
  })
...
resource "aws_iam_role_policy" "github_verification_deploy" {
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      { Effect = "Allow", Action = ["ecr:BatchCheckLayerAvailability", "ecr:CompleteLayerUpload", "ecr:DescribeImages", "ecr:InitiateLayerUpload", "ecr:PutImage", "ecr:UploadLayerPart"], Resource = aws_ecr_repository.verification.arn },
