...
import { Activity, BadgeCheck, CalendarDays, ClipboardList, GalleryVerticalEnd, Gavel, MapPinned, Megaphone, MessagesSquare, MessageSquare, Newspaper, ShieldAlert, Users, Workflow } from 'lucide-react';
import type { GateworkMember } from '@/lib/types';

const items = [
  ['Komuta Merkezi', '/command-center', Activity], ['İçerik Stüdyosu', '/content', GalleryVerticalEnd], ['Haber Merkezi', '/news', Newspaper], ['Tanıtımlar', '/promotions', Megaphone], ['Etkinlikler', '/events', CalendarDays], ['Üyeler', '/members', Users], ['Moderasyon', '/moderation', ShieldAlert], ['Çarşı ve İhaleler', '/marketplace', Gavel], ['Forum', '/forum', MessagesSquare], ['Mesajlar', '/communications', MessageSquare], ['Güvenlik ve SOS', '/safety', Workflow], ['Analitik ve Konum', '/analytics', MapPinned], ['Doğrulama', '/verification', BadgeCheck], ['Sistem ve Denetim', '/system', ClipboardList],
] as const;
