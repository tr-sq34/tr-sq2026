...
const sections: Record<string, { title: string; text: string }> = {
  ...
  // Every other section now has its own route, backed by Identity, Community,
  // the messaging gateway or the verification vault; a static segment wins over
  // this catch-all, so leaving their placeholders here would only be dead copy.
  // What is left is the three studios above, which still live here.
};
