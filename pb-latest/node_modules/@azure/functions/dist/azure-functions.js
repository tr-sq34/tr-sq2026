...
function converToMcpToolTriggerOptionsToRpc(mcpToolTriggerOptions) {
    ...
    if (!(mcpToolTriggerOptions === null || mcpToolTriggerOptions === void 0 ? void 0 : mcpToolTriggerOptions.toolProperties)) {
        return Object.assign(Object.assign({}, baseResult), { toolProperties: JSON.stringify([]) });
    }
    ...
    if (Array.isArray(mcpToolTriggerOptions.toolProperties)) {
        ...
        if (isValid) {
            return Object.assign(Object.assign({}, baseResult), { toolProperties: JSON.stringify(mcpToolTriggerOptions.toolProperties) });
        }
        else {
            throw new Error('Invalid toolProperties: Array contains invalid McpToolProperty, please validate the parameters.');
        }
    }
    ...
    if (typeof mcpToolTriggerOptions.toolProperties === 'object') {
        ...
        const toolProperties = mcpToolTriggerOptions.toolProperties;
        // Check if the object is a ZodObject
        if (((_a = toolProperties === null || toolProperties === void 0 ? void 0 : toolProperties._def) === null || _a === void 0 ? void 0 : _a.typeName) === 'ZodObject') {
            isZodObject = true;
        }
        // Check if shape is a valid ZodObject shape
        const shape = isZodObject
            ? toolProperties.shape
            : toolProperties;
        ...
        const result = Object.keys(shape).map((propertyName) => {
            ...
            const description = ((_a = property === null || property === void 0 ? void 0 : property._def) === null || _a === void 0 ? void 0 : _a.description) || '';
            const propertyType = getPropertyType(((_c = (_b = property === null || property === void 0 ? void 0 : property._def) === null || _b === void 0 ? void 0 : _b.typeName) === null || _c === void 0 ? void 0 : _c.toLowerCase()) || 'unknown'); // Extract type name or default to "unknown"
            return {
                propertyName,
                propertyType,
                description,
        ...
        return Object.assign(Object.assign({}, baseResult), { toolProperties: JSON.stringify(result) });
    }
...
function getPropertyType(zodType) {
    switch (zodType) {
        case 'zodnumber':
            return 'number';
        case 'zodstring':
 ...
 */
function isMcpToolProperty(property) {
...
// Licensed under the MIT License.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.generic = exports.mcpTool = exports.webPubSub = exports.mySql = exports.sql = exports.warmup = exports.cosmosDB = exports.eventGrid = exports.eventHub = exports.serviceBusTopic = exports.serviceBusQueue = exports.storageQueue = exports.storageBlob = exports.timer = exports.http = void 0;
const addBindingName_1 = __webpack_require__(/*! ./addBindingName */ "./src/addBindingName.ts");
